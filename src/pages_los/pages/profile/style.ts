...
export interface ProfilePageStyleProps {
  paper: BaseCSSProperties;
  pageTitle: BaseCSSProperties;
  fixedHeight: BaseCSSProperties;
  submit: BaseCSSProperties;
  backBtn: BaseCSSProperties;
}

export type ProfilePageNameProps = Record<keyof ProfilePageStyleProps, string>;

export const profilePageStyle = (theme: Theme): any => ({
  pageTitle: {
    color: "#26A456",
    letterSpacing: "2px",
    fontSize: "1.75rem",
