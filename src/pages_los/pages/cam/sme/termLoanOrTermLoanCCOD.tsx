import "../styles.css";
export const TermLoanOrTermLoanCCOD = () => {
  return (
    <div id="camPreviewTable">
      <table className="page">
        ...
        <tr>
          ...
          <td colSpan={4}>For purchase of Machineries </td>
        </tr>
        <tr>
        ...
        <tr>
          <th colSpan={2}>GPCB License</th>
          <td colSpan={4}>N/A</td>
        </tr>
        <tr>
          <th colSpan={2}>Factory License</th>
          <td colSpan={4}>N/A</td>
        </tr>
        <tr>
          <th colSpan={2}>FASSAI License </th>
          <td colSpan={4}>N/A</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <th>Total Amount (In Lacs)</th>
          <th>Amount Incurred (In Lacs)</th>
        </tr>
        <tr>
          <td colSpan={2}>Factory building</td>
          <td>25,000</td>
          <td>25 Lakh</td>
        </tr>
        <tr>
          <td colSpan={2}>Plant & Machinery – Domestic</td>
          <td>25,000</td>
          <td>25 Lakh</td>
        </tr>
        <tr>
          <td colSpan={2}>Plant & Machinery – Imported</td>
          <td>25,000</td>
          <td>25 Lakh</td>
        </tr>
        <tr>
          <td colSpan={2}>Electrification</td>
          <td>25,000</td>
          <td>25 Lakh</td>
        </tr>
        <tr>
          <td colSpan={2}>Interest During Construction Period</td>
          <td>25,000</td>
          <td>25 Lakh</td>
        </tr>
        <tr>
        ...
        <tr>
          <td colSpan={2}>Promoter’s Contribution</td>
          <td>25 Lakh</td>
          <td>20 Lakh</td>
        </tr>
        <tr>
          <td colSpan={2}>Term Loan</td>
          <td>25 Lakh</td>
          <td>20 Lakh</td>
        </tr>
        <tr>
          <td colSpan={2}>Unsecured Loan</td>
          <td>25 Lakh</td>
          <td>20 Lakh</td>
        </tr>
        <tr>
        ...
        <tr>
          <td colSpan={6}>
            *Estimated and Projected turnover for the next two years is Rs.__ in
            FY __ and Rs. __ in FY ___.
          </td>
        </tr>
        {/* //step five */}
        <tr>
