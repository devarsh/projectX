...
const BecomeGrowthPartner: MetaDataType = {
  form: {
    ...
    render: {
      ordering: "auto",
      renderType: "stepper",
      groups: ["Partner Details", "Partner Details 2"],
      gridConfig: {
        item: {
          xs: 12,
          sm: 4,
  ...
  fields: [
    {
      ...
      options: [
        { label: "Individual", value: "I", iconName: "person" },
    ...
    },
    {
      ...
      schemaValidation: {
        type: "string",
        rules: [{ name: "required", params: ["Address is required"] }],
      },
      GridProps: {
        xs: 12,
        md: 3,
...
export default BecomeGrowthPartner;
